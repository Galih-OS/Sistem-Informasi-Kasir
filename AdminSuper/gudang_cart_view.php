<table width="100%" border="0" cellspacing="0" cellpadding="0" class="viewer">
  ...
  <tr>
    ...
    <td align="center">
		<a href="gudang_cart.php?act=plus&amp;barang_id=<?php echo $key; ?>&amp;ref=index.php?page=gudang_permintaan_material_baru">+</a> |
		<a href="gudang_cart.php?act=min&amp;barang_id=<?php echo $key; ?>&amp;ref=index.php?page=gudang_permintaan_material_baru">-</a> |
		<a href="gudang_cart.php?act=del&amp;barang_id=<?php echo $key; ?>&amp;ref=index.php?page=gudang_permintaan_material_baru">Hapus</a>
	</td>
  </tr>
  <?php
  ...
  <tr>
	<td align="right" colspan="4"><strong>TOTAL :
		<?php
			$total = 0;
			foreach ($_SESSION['admin_items'] as $key2 => $val){
...
<?php
	if(isset($_POST['simpan'])){
		...
		$query2 = mysql_query ("INSERT INTO pembelian
								VALUES ('".$id_pembelian."', '".$_SESSION['admin']."','".$_POST['id_supplier']."' , '".date('Y-m-d H:i:s')."', ".$total.", ".$max.") ");
		...
		echo '<script languange="javascript">window.location="index.php?page=gudang_permintaan_material_baru"</script>';
	}
?>