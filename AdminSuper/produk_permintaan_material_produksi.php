...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr valign="top">
    <td width="35%">
		...
		<h4>List Material</h4><hr/>
		  ...
		  <tr>
			...
			<td>
			  <a href="produk_cart.php?act=add&amp;barang_id=<?php echo $rs['id_bahan']; ?>&amp;ref=index.php?page=produk_permintaan_material_produksi2">Add to List</a>
			</td>
		  </tr>
		  <?php
			}
    ...
    <td width="60%"><h4>List Order</h4><hr/>
      <?php require("produk_cart_view.php"); ?></td>
  </tr>
</table>
<p>&nbsp;</p>