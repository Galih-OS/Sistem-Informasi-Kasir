<table width="100%" border="0" cellspacing="0" cellpadding="0" class="viewer">
  ...
  <tr>
    ...
    <td align="right">
		<a href="cart.php?act=plus&amp;barang_id=<?php echo $key; ?>&amp;ref=index.php?page=form_input_penjualan">+</a> |
		<a href="cart.php?act=min&amp;barang_id=<?php echo $key; ?>&amp;ref=index.php?page=form_input_penjualan">-</a> |
		<a href="cart.php?act=del&amp;barang_id=<?php echo $key; ?>&amp;ref=index.php?page=form_input_penjualan">Hapus</a>
	</td>
  </tr>
  <?php
  ...
  <tr>
	<td align="right" colspan="4"><strong>TOTAL :
		<?php
			$total = 0;
			foreach ($_SESSION['produk_jadi'] as $key2 => $val){
  ...
  <tr>
    ...
    <td align="center" colspan="2"><br/>
			...
			<a class="btn btn-danger btn-sm" href="cart.php?act=clear&amp;ref=index.php?page=form_input_penjualan">Batal</a>
		</form>
	</td>
  </tr>
</table>
...
<?php
	if(isset($_POST['simpan'])){
		...
		$query1 = mysql_query ("INSERT INTO penjualan
								VALUES ('".$id_penjualan."', '".date('Y-m-d H:i:s')."' , '".$_SESSION['username']."' , ".$total." , ".$_POST['tunai']." , ".$kembali." , ".$max.") ");
		
		// MENCATAT KEDALAM TABEL PENJUALAN
		date_default_timezone_set("Indonesia/Jakarta");
		$query2 = mysql_query ("INSERT INTO permintaan_penjualan
								VALUES ('".$id_permintaan_penjualan."', '".$id_penjualan."', '".date('Y-m-d H:i:s')."' , 'P1' , '".$_SESSION['username']."' , ".$total." , ".$maxx.", 'pending') ");
		...
		echo '<script languange="javascript">window.location="index.php?page=form_input_penjualan"</script>';
		} else {
