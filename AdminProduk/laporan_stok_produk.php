...
<?php
	...
	echo "	<tr align='center'>
				...
				<td><input size='15' read-only name='uas' value='".$row['nama_barang']."'></td>
				<td><input size='5' read-only name='' value='".$row['stok']."'></td>
				<td><input size='3' read-only name='tugas' value='".number_format($row['harga'])."'></td>";
	echo "
				</form>
			</tr>";
	$no++;
